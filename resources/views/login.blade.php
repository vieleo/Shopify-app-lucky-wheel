...
<head>
    ...
    <script type="text/javascript">
        window.$crisp=[];window.CRISP_WEBSITE_ID="835d8ee6-a11f-45bd-95a5-d5890cafdd37";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();
        <?php
            $user  = Auth::user();
            if($user){
                echo '$crisp.push(["set", "user:email", ["' . $user->email . '"]]); $crisp.push(["set", "user:nickname", ["' . $user->name . '"]]);';
            }
        ?>
    </script>
</head>
